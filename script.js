/* ============================================================
   POPOROPO — SCRIPT.JS  (TMDB Bearer Token + 11 servidores directos + TV/Móvil)
   ============================================================ */
...
/* ============================================================
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // Contenedor de botones de servidor (dinámico)
    ...
    // Helper para obtener todos los botones actuales
