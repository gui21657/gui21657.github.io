/* ============================================================
   POPOROPO — SCRIPT.JS  (TMDB Bearer Token + 11 servidores
   directos + optimización extrema TV/Móvil/Memoria baja)
   ============================================================ */
...
/* ============================================================
   ...
   (function () {
    ...
    const ALLOWED_DOMAINS = [
      ...
      'themoviedb.org',
      'image.tmdb.org',
      'vidsrc.xyz', 'vidsrc.to', 'vidsrc.me', 'vidsrc.in', 'vidsrc.pm', 'vidsrc.cc', 'vidsrc.net',
      'embed.su', '2embed.cc', '2embed.skin', 'multiembed.mov', 'vidlink.pro',
  ...
  // Detección de baja memoria / dispositivo lento
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    /* ────────────────────────────────────────────────
       CARGA DE SERVIDOR (manual, sin auto‑fallback)
       ──────────────────────────────────────────────── */
    ...
    /* ────────────────────────────────────────────────
       CARRUSELES (con lazy loading de secciones)
       ──────────────────────────────────────────────── */
    function createCarouselSection(genre) {
      ...
      // Función para cargar el carrusel realmente
      ...
      // IntersectionObserver: cargar cuando esté cerca (-100px de margen)
      ...
      }, { rootMargin: '200px' }); // margen generoso para que cargue antes de llegar
    ...
    function buildCatalog() {
      ...
      catalog.innerHTML = '';
      // Todas las secciones se crean en el DOM, pero sus carruseles no cargan películas hasta que son visibles
